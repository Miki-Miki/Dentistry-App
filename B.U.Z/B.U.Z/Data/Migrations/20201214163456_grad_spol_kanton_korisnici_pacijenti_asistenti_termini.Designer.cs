...
namespace B.U.Z.Data.Migrations
{
    ...
    [Migration("20201214163456_grad_spol_kanton_korisnici_pacijenti_asistenti_termini")]
    partial class grad_spol_kanton_korisnici_pacijenti_asistenti_termini
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("B.U.Z.Models.Korisnik", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("B.U.Z.Models.Termini", b =>
                {
                    ...
                    b.HasIndex("AsistentId1");

                    b.HasIndex("PacijentId1");
            ...
            modelBuilder.Entity("B.U.Z.Models.Asistent", b =>
                {
                    b.HasBaseType("B.U.Z.Models.Korisnik");
            ...
            modelBuilder.Entity("B.U.Z.Models.Termini", b =>
                {
                    b.HasOne("B.U.Z.Models.Asistent", "Asistent")
                        .WithMany()
                        .HasForeignKey("AsistentId1");

                    b.HasOne("B.U.Z.Models.Pacijent", "Pacijent")
                        .WithMany()
                        .HasForeignKey("PacijentId1");
                });
